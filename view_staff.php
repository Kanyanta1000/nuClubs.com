...
$view_staff = new main_class;

$columns = "*";
$table = "staff";
$condition = "1 ORDER BY name";

$query_result = $view_staff->select($columns,$table,$condition);
...
<div id="club_members_wrapper" style="width: 60%; margin-left:20%; float:left;">
    <div id="staff_id_heading" style="width: 15%; float:left;"><h3>Staff ID</h3></div>
    <div id="staff_name_heading" style="width: 30%; float:left;"><h3>Name</h3></div>
    <div id="sex_heading" style="width: 10%; float:left;"><h3>Sex</h3></div>
    <div id="designation_heading" style="width: 45%; float:left;"><h3>Designation</h3></div>
    <?php
    echo "\n\n\n\n";
    while($result = mysql_fetch_assoc($query_result))
                {?>
                    <div align="justify" id="staff_id" style="width: 15%; float:left;">
                        <?php
                            echo $student_id = $result['staff_id'];
                        ?>
                    </div>
                    
                    <div id="staff_name" style="width: 30%; float:left;">
                        <?php
                            echo $staff_name = $result['name'];
                        ?>
                    </div>
                    
                    <div id="sex" style="width: 10%; float:left;">
                        <?php						
                            echo $result['sex'];
                        ?>
                    </div>
                    
                    <div id="designation" style="width: 25%; float:left;">
                        <?php						
                            echo $result['title'];
                        ?>
                    </div>
                    ...
                    <?php
						echo "<a href=delete_staff.php?staff_id=";
						echo $result['staff_id']." title = 'Delete staff member'>";
						echo "Delete"."</a>";
					?>
                    </div>
