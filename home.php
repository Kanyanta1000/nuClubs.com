...
<body>
<!-- InstanceBeginEditable name="nav_behaviour" --><body onLoad="MM_effectShake('home')">
<!-- InstanceEndEditable -->
...
<div style="margin-left: 20%;"><h5>Click on a club's name to go to its home page</h5></div>
    ...
    <?php
        ...
        else 
		{
            ...
            <div id="club_row" style="width:100%; float: left;">
                ...
                <div id="creation_date" style="width: 20%; float:left; margin-right: 20%;">
