...
$view_suggestion = new main_class;

$suggestion_id = $_GET['suggestion_id'];

$columns = "*";
$table = "suggestion";
$condition = "suggestion_id = $suggestion_id ORDER BY suggestion_id";

$query_result = $view_suggestion->select($columns,$table,$condition);
...
<title><?PHP echo $result['suggestion_title']; ?></title>
<!-- InstanceEndEditable -->
...
<div id="suggestion_title_heading" style="width: 100%; float:left; margin-top:5px; margin-left:30%;"><h3><?PHP echo $result['suggestion_title']; ?></h3></div>
...
<?PHP
	...
	echo " added by ".$student_name_result['name'];
?></div>
...
<?php
	echo $result['suggestion_details'];
?>
</div>
<div align="center">
