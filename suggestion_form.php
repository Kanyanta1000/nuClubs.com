...
<form id="form1" name="form1" method="post" action="submit_suggestion.php" style="width:60%; margin-left:30%;">

	<div id="student_id_label" align="left" style="width:100%; float:left; margin-top:20px;">
        <h3>Student ID:</h3>
    </div>
    <div id="student_id" style="width:100%; float:left; margin-top:5px;">
         <input name="student_id" type="text" id="student_id"  size="20" maxlength="6" />
    </div>

    <div id="suggestion_label" align="left" style="width:100%; float:left; margin-top:20px;">
        <h3>Suggestion Title:</h3>
    </div>
    <div id="event" style="width:100%; float:left; margin-top:5px;">
         <input name="suggestion_title" type="text" id="suggestion_title" value="" size="64" maxlength="64" />
    </div>
    
    <div id="suggestion_details_label" style="width:100%; float:left; margin-top:20px;">
         <h3>Suggestion Details:</h3>
    </div>
    <div id="suggestion_details" style="width:100%; float:left; margin-top:5px;">
         <textarea cols="61" rows="10" name="suggestion_details" id="suggestion_details"></textarea>
  	</div>
    
    <div style="width:100%; float:left; margin-top:20px;">
		<input type="submit" name="upload" id="upload" value="Add suggestion" style="float:left;"/>
    </div>
