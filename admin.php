...
<body>
<!-- InstanceBeginEditable name="nav_behaviour" --><body onLoad="MM_effectShake('admin')">
<!-- InstanceEndEditable -->
...
$admin = new main_class;

$columns = "*";
$table = "proposal";
$condition = "approval_status = '1'";

$query_result = $admin->select($columns,$table,$condition);

?>    
    
    
    <div id="admin_wrapper" style=" width:60%; margin-left:20%;">
      <p><a href="add_student_form.php">Add a student</a></p>
      <p><a href="add_staff_form.php">Add a staff member</a></p>
      <p><a href="view_staff.php">View all staff</a></p>
      <p><a href="view_students.php">View all students</a></p>
      <p><a href="delete_club_form.php">Delete a club</a></p>
   </div>
